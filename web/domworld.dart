...
var DEFAULT_CAVE = 3;
var DEFAULT_HILLCRATER = 150;
var DEFAULT_SEAPROVSIZE = 400;
var AGES = ['EA', 'MA', 'LA'];
var HOF = [5, 10, 15];
...
class DomWorld {
  ...
  var cave, hillcrater, seaprovsize;
  var mapdim, mapname;
  ...
  DomWorld(words) {
    ...
    cave = rollSucc(20, DEFAULT_CAVE, 100) * 5;
    hillcrater = rollSucc(20, DEFAULT_HILLCRATER, 1000) * 50;
    seaprovsize = rollSucc(20, DEFAULT_SEAPROVSIZE, 1000) * 50;
...
CAVE: ${cave}
RUGGED: ${rugged}
HILLS/CRATER: ${hillcrater}
RIVER: ${river}
SEA PROVINCE SIZE: ${seaprovsize}
